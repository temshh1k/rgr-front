...
const Category = (props) =>{
    ...
    let finder = (event) => {
        if (event.key === 'Enter') {
            ...
            let url = DOMEN_SERVER + `products/find/category?count=1&size=10`;
    ...
    let changePage = (value) => {
        ...
        let url = DOMEN_SERVER + `products/find/category?count=${value}&size=10`;
    ...
    return (<div>
        {error === true ?
            <div className={s.cont}>
                ...
                <div className={s.findPane}> К сожалению по запросу {inputFind} ничего не найдено</div>
            </div>
            :
            <div className={s.cont}>
                <div className={s.inputer}>
